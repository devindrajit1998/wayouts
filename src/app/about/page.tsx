  ...
  return (
    <main className="o-hidden">
      ...
      <PageBanner
        ...
        italicTitle="Wayouts travel agency"
        image="/assets/img/destination/01.jpg"
      />

      {/* About Section */}
      <section className="about2 section-padding" data-scroll-index="1">
        <div className="container">
          <div className="row">
            <div className="col-md-6">
              <div className="about2-img">
                <div className="main-img img-cover duru-slide-down">
                  <img src="/assets/img/a4.jpg" alt="About Wayouts" />
                </div>
                <div className="main-img img-cover duru-slide-up">
                  <img src="/assets/img/a2.jpg" alt="About Wayouts" />
                </div>
              </div>
            </div>
            <div className="col-md-5 offset-md-1">
              ...
              <div className="customers d-flex align-items-center">
                ...
                <Link href="/services" className="butn-arrow wow fadeInUp" data-wow-delay=".8s">
      ...
      {/* Services Component */}
      <ServicesSection bgImage="/assets/img/destination/05.jpg" />

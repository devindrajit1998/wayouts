                        ...
                        <div className="row mb-60 justify-content-center">
                            <div className="col-md-6 text-center">
                                ...
                                <div className="post">
                                    ...
                                    <div className="date-comment"> <i className="fa-solid fa-envelope"></i> info@tourvex.com</div>
                    ...
                    <div className="container-fluid">
                        <div className="height1">
                            <div className="radius-mask">
                                <div className="bg-img height2" data-background="/assets/img/destination/03.jpg" data-speed="0.5" data-lag="0"></div>
                            </div>
                        </div>
                    </div>
                </header>
                    ...
                    <div className="container">
                        <div className="row justify-content-center align-items-center">
                            <div className="col-md-4">
                                <div className="item-img duru-rotate-scale-reveal"><img src="/assets/img/destination/b.jpg" alt="" /></div>
                            </div>
